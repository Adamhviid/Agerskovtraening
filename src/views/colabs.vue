    ...
    <Layout>
        <div>
            ...
            <div class="box">
                ...
                <a
                    href="https://dragostore.dk?sca_ref=4564852.mAwBi8EJ23"
                    target="_blank"
                    class="bg-blue-950 hover:text-[#32579a] mt-5 text-white font-bold py-2 px-4 rounded-full">
                    Til DRAGO
                </a>
            </div>
            <div class="box">
                <div class="mx-auto max-w-2xl mb-5 lg:text-center">
                    ...
                    <h4 class="mt-3 relative mt-1">
                        ...
                        hjulpet mig med at udstråle professionalisme og stil i alle aspekter af min virksomhed.
                    </h4>
                    <h4 class="mt-3 relative mt-1">FÅ 10% RABAT MED “AGERSKOV10”.</h4>
                </div>
                <a
                    href="https://thebodyfactory.dk"
                    target="_blank"
                    class="bg-blue-950 hover:text-[#32579a] mt-5 text-white font-bold py-2 px-4 rounded-full">
                    Til TBF
                </a>
