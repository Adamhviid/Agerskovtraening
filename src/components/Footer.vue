        ...
        <div class="font-bold text-xl lg:text-right lg:flex-row lg:justify-center">
          ...
          <div class="flex justify-center sm:justify-end space-x-5 mt-1">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/profile.php?id=100086447864797">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19" class="h-6 w-6" >
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.tiktok.com/@agerskov_traening">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true"  viewBox="0 0 448 512" class="h-6 w-6">
